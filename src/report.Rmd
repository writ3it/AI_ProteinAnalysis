...
Regression analysis in this report is an good admission to proper classification. The following parameters have been selected experimentally. Cutoff is an treshold for attributes spearman factor. Because dataset is big, training set will be 90% of whole. Choosed algorithm is Linear Regression which is standard algorithm for numeric prediction.
```{r reg_params}
cutoff.reg<-0.4
part.reg<-0.9
```
